"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Custom lightline theme based on PaperColor
" Modified to account for PaperColor light customizations
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
let s:p.inactive.right = [ [ s:foreground, s:background ], [ s:foreground, s:inactive_bg ] ]
let s:p.inactive.left = [ [ s:foreground, s:background ], [ s:foreground, s:inactive_bg ] ]
let s:p.inactive.middle = [ [ s:foreground, s:inactive_bg], ]
...
let g:lightline#colorscheme#TiffCustomPaperColor#palette = lightline#colorscheme#fill(s:p)
